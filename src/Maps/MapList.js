                                            ...
                                            <div style={{height: itemHeight}} key={`${item.id}-${index}`}>
                                                ...
                                                >
                                                    <div
                                                        style={{
                                                            width: '33%',
                                                            backgroundImage: `url(${item.mapImage})`,
                                                            backgroundSize:
                                                                'cover',
                                                            backgroundPosition:
                                                                'center',
                                                ...
                                                <Modal show={data[index].map} onHide={() => this.closeMap(index)} dialogClassName="map-modal">
                                                    <Modal.Body>
                                                        ...
                                                        <div style={{backgroundColor: HeavyOrange, fontSize: "28pt", padding: 20, textAlign: "center" }}>MAP OF<br/>{item.title.toUpperCase()}</div>
                                                        <ReactImageMagnify {...{
                                                            smallImage: {
