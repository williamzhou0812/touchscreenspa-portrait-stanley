                        ...
                        <div style={{ height: "50%" }}>
                            <div style={{ height: "13%", display: "flex" }}>
                                ...
                                >
                                    <span
                                        style={
                                            this.styles.nextOrPreviousButtonText
                                        }
                                    >
                                        PREVIOUS EVENT
                                    </span>
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        {event.phone && (
                                            <div>CALL TODAY: {event.phone}</div>
                                        )}
                                        {event.website && (
                                            <div>WEBSITE: {event.website}</div>
                                        )}
                                        {event.email && (
                                    ...
                                    >
                                        <div
                                            style={
                                                this.styles.mapOrFindButtonStyle
                                            }
                                        >
                                            <span
                                                style={
